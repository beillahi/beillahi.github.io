...
\begin{nonumregion}{\lbar{red}Education}
  \begin{education}{Doctorate --- Computer Science}
    ...
    \item
      \begin{itemize}
      \item Thesis Title: \href{https://beillahi.github.io/papers/thesis.pdf}{\textbf{Automated Reasonning about Weak Consistency in Distributed Software}}
        \vspace{-0.5ex}
...
\begin{nonumregion} {\lbar{orange}Experience}
  ...
  %\end{position}
  \begin{position}{Research Assistant, Universit\'{e} de Paris}{Dec 2017 -- Mar 2021}
...
\begin{region} {\lbar{purple}Conference Publications}{{C}1}{8}
  ...
  \begin{publication} {https://beillahi.github.io/papers/SolidityGasOptimization.pdf}
		{Smart Contracts Refinement for Gas Optimization}
		{Apr 2021} {Keerthi Nelaturu, Sidi Mohamed Beillahi, Fan Long, Andreas Veneris}
  ...
  \begin{publication} {https://beillahi.github.io/papers/asynchrony.pdf}
		...
		{Jan 2021} {Sidi Mohamed Beillahi, Ahmed Bouajjani, Constantin Enea, Shuvendu Lahiri}
		{under submission, 2021}
  \end{publication}
