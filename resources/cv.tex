...
\begin{tikzpicture}[remember picture,overlay]
  ...
  \node [anchor=center] (name) at (box) {%
    ...
    \begin{tabular*}{7.5in}{@{\extracolsep{\fill}}lr}
      ...
      \href{mailto:sm.beillahi@utoronto.ca}{sm.beillahi@utoronto.ca} & \emph{Tel}: \textrm{(1) 438 921 7395}\\
...
\begin{region} {\lbar{black}Conference Publications}{{C}1}{17}
  ...
  \begin{publication} {https://arxiv.org/pdf/2206.10708.pdf}
		...
		{Conditionally accepted to the 46th International Conference on Software Engineering (ICSE 2024)}
  \end{publication}
