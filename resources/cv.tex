...
\begin{tikzpicture}[remember picture,overlay]
  ...
  \node [anchor=center] (name) at (box) {%
    ...
    \begin{tabular*}{7.5in}{@{\extracolsep{\fill}}lr}
      ...
      Paris, France - 75013 \\
      \href{mailto:med.beillahi@gmail.com}{med.beillahi@gmail.com}\\
...
\item \hspace{1ex} \parbox{7.3in}{I am interested in algorithmic verification, formal methods, and applying programming
	language techniques to improve asynchronous, concurrent, distributed, and quantum systems and smart contracts.}
\end{nonumregion}
...
\begin{itemregion} {\lbar{blue}Service}
  ...
  \service{Artificat Evaluation Committees: POPL 2021, CAV 2021.}
...
\begin{region} {\lbar{purple}Conference Publications}{{C}1}{7}
  ...
  \begin{publication} {https://beillahi.github.io}
		...
		{Dec 2020} {Sidi Mohamed Beillahi, Ahmed Bouajjani, Constantin Enea}
		{In Proc. 30th European Symposium on Programming (ESOP), 2021}
  \end{publication}

  \begin{publication} {https://beillahi.github.io}
		{Automated Synthesis of Asynchronizations}
		{Jul 2020} {Sidi Mohamed Beillahi, Ahmed Bouajjani, Constantin Enea, Shuvendu Lahiri}
  ...
  \end{publication}
	...
	\begin{publicationNote} {https://beillahi.github.io/papers/CONCUR19.pdf}
		{Robustness Against Transactional Causal Consistency}
