...
\begin{region} {\lbar{purple}Conference Publications}{{C}1}{13}
  ...
  \begin{publication} {https://arxiv.org/pdf/2206.10708.pdf}
		...
		{2022} {Zhiyang Chen, Sidi Mohamed Beillahi, Fan Long}
		{under prepartion, https://arxiv.org/abs/2206.10708}
  \end{publication}

  \begin{publication} {https://beillahi.github.io}
		{LVMT: An Efficient Authenticated Storage for Blockchain} 
		{2022} {Chenxing Li, Sidi Mohamed Beillahi, Guang Yang, Ming Wu, Wei Xu, Fan Long}
  ...
  \begin{publication} {https://arxiv.org/pdf/2102.10784.pdf}
		...
		{Dec 2022} {Zihan Zhao, Sidi Mohamed Beillahi, Ryan Song, Yuxi Cai, Andreas Veneris, Fan Long}
		{ACM SIGPLAN conference on Object-oriented Programming, Systems, Languages, and Applications (OOPSLA) 2022, (conditionally accepted)}
  \end{publication}

  \begin{publication} {https://beillahi.github.io/papers/asynchrony.pdf}
		{Automated Synthesis of Asynchronizations}
		{Dec 2022} {Sidi Mohamed Beillahi, Ahmed Bouajjani, Constantin Enea, Shuvendu Lahiri}
...
\begin{itemregion}{\lbar{red}Teaching}
  ...
  \service{Course Instructor at University of Toronto}
  \begin{itemize}
    \service{ECE345H1F: Algorithms \& Data Structures, Sep 2022 -- Dec 2022.}
  \end{itemize}
...
\begin{itemregion}{\lbar{red}Supervision}
  %\service{Lecturer:}
  %\service{Guest Lectures:}
  %\service{Supervisions at Concordia University:}
  ...
  \service{Srisht Fateh Singh, MASc student, University of Toronto}
  \service{Hossein Ghotbaddini, MASc student, University of Toronto}
  %\service{Projects supervised:}
\end{itemregion} 
