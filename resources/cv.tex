...
\item \hspace{1ex} \parbox{7.3in}{Software engineering; Software security; Software verification; Distributed systems; Blockchain; Formal verification; Algorithmic verification; Programming languages; Program synthesis.}
\end{nonumregion}
...
\begin{nonumregion} {\lbar{black}Experience}
  ...
  \positionnodesc{Mitacs Accelerate Postdoctoral Fellow, University of Toronto and Bank of Canada}{Sep 2022 -- present}
		%{Advisors: Fan Long and Andreas Veneris}{Toronto, Canada}
  %\end{position}
  %\positionnodesc{Course Instructor, York University}{}
...
\begin{itemregion} {\lbar{black}Awards and Recognitions}
  \service{ACM SIGSOFT Distinguished Paper Award, ICSE 2024.}
...
\begin{itemregion} {\lbar{black}Grants and Scholarships}
  \service{PI in a MITACS Mitacs Business Strategy Grant, 2024, CAD 31,000.}
  \service{PI in two MITACS Accelerate Partnership Grants, 2022 -- 2024, CAD 205,500.}
...
\begin{itemregion} {\lbar{black}Service}
  ...
  \service{Artificat Evaluation Committees: POPL 2021-2022, CAV 2021, CAV 2024, OOPSLA 2021-2022.}
...
\begin{region} {\lbar{black}Journal Publications}{{J}1}{5}
  ...
  \begin{publicationNote} {https://beillahi.github.io}
		...
		{2024} {Chenxing Li, \textbf{Sidi Mohamed Beillahi}, Guang Yang, Ming Wu, Wei Xu, Fan Long}
		{Accepted to the ACM Transactions on Storage}
  ...
  \begin{publicationNote}{https://arxiv.org/pdf/LMPTExt.pdf}
    ...
    {Apr 2024}{Jemin Andrew Choi, \textbf{Sidi Mohamed Beillahi}, Srisht Fateh Singh, Panagiotis Michalopoulos, Peilun Li, Andreas Veneris, Fan Long}
    {IEEE Transactions on Network and Service Management, 21(2), 1333 -- 1343}
...
\end{region}
%\newpage
\begin{region} {\lbar{black}Conference Publications}{{C}1}{22}

  \begin{publication} {https://beillahi.github.io}
		{Enforcing Control Flow Integrity on DeFi Smart Contracts} 
		{2024} {Zhiyang Chen, \textbf{Sidi Mohamed Beillahi}, Pasha Barahimi, Cyrus Minwalla, Han Du, Andreas Veneris, Fan Long}
		{under submission}
  \end{publication}

  \begin{publication} {https://beillahi.github.io}
		{OpenTracer: A Dynamic Transaction Trace Analyzer for Smart Contract Invariant Generation and Beyond} 
		{2024} {Zhiyang Chen, Ye Liu, \textbf{Sidi Mohamed Beillahi}, Yi Li, Fan Long}
		{In Proc. The 39th IEEE/ACM International Conference on Automated Software Engineering, Tool Demonstrations Track (ASE 2024 Demo)}
  \end{publication}

  \begin{publication} {https://arxiv.org/pdf/2407.05411}
		{Assessing Code Generation with Intermediate Languages} 
		{2024} {Xun Deng, Sicheng Zhong, Honghua Dong, Jingyu Hu, \textbf{Sidi Mohamed Beillahi}, Xujie Si, Fan Long}
		{under submission}
  \end{publication}
  ...
  \begin{publication} {https://beillahi.github.io}
		{Infernomic: A Decentralized System for Economic LLM Inference} 
		{2024} {Haohui Mai, \textbf{Sidi Mohamed Beillahi}, Yiyang Zhao, Guanqun Yang, Qianqi Sun, Jingbo Shang, Jiacheng Zhao, Xueqing Liu, Mingyu Gao, Christos Kozyrakis}
		{under submission}
  \end{publication}

  \begin{publication} {https://arxiv.org/abs/2404.14580.pdf}
		{Demystifying Invariant Effectiveness for Securing Smart Contracts} 
		{Jul 2024} {Zhiyang Chen, Ye Liu, \textbf{Sidi Mohamed Beillahi}, Yi Li, Fan Long}
		{In Proc. The ACM International Conference on the Foundations of Software Engineering (FSE 2024)}
  \end{publication}
  ...
  \begin{publication} {https://arxiv.org/pdf/2206.10708.pdf}
		...
		{Apr 2024} {Zhiyang Chen, \textbf{Sidi Mohamed Beillahi}, Fan Long}
  ...
  \begin{publication} {https://arxiv.org/pdf/2401.06044.pdf}
		...
		{Apr 2024} {Xun Deng, \textbf{Sidi Mohamed Beillahi}, Cyrus Minwalla, Han Du, Andreas Veneris, Fan Long}
		{In Proc. 46th IEEE/ACM International Conference on Software Engineering (ICSE 2024)}
  ...
  \begin{publication} {https://beillahi.github.io/papers/OSDI23.pdf}
		{LVMT: An Efficient Authenticated Storage for Blockchain} 
		{Jul 2023} {Chenxing Li, \textbf{Sidi Mohamed Beillahi}, Guang Yang, Ming Wu, Wei Xu, Fan Long}
  ...
  \begin{publication} {https://beillahi.github.io/papers/DAPPS23.pdf}
		...
		{Jul 2023} {Xun Deng, Zihan Zhao, \textbf{Sidi Mohamed Beillahi}, Han Du, Cyrus Minwalla, Keerthi Nelaturu, 
...
\begin{itemregion}{\lbar{black}Teaching}
  ...
  \service{Course Instructor at York University}
  \begin{itemize}
    \service{EECS3342Z: System Specification and Refinement for 3rd Year Software Engineering Students, Jan 2024 -- present.}
  \end{itemize}
...
\begin{itemregion}{\lbar{black}Talks}
  ...
  \item \begin{tabular*}{7.5in}{l@{\extracolsep{\fill}}r}
    ...
    \hspace{1ex} Département d'Informatique, Université du Québec à Montréal (UQAM)   & \textit{Jul 2024}\\
    \hspace{1ex} School of Information Technology, York University (virtual) & \textit{Apr 2024}
  \end{tabular*}

  \item \begin{tabular*}{7.5in}{l@{\extracolsep{\fill}}r}
    \textbf{Synthesis of Multi-Threaded (\& Asynchronous) Programs} \\
    \hspace{1ex} 13th Workshop on Synthesis (SYNT 2024) at CAV 2024, Montréal, Canada  & \textit{Jul 2024}
  \end{tabular*}

  \item \begin{tabular*}{7.5in}{l@{\extracolsep{\fill}}r}
    \textbf{Securing Smart Contracts Through Program Synthesis} \\
    \hspace{1ex} IRIF Verification Seminar, Université Paris Cité (virtual)  & \textit{Apr 2024}
  \end{tabular*}

  \item \begin{tabular*}{7.5in}{l@{\extracolsep{\fill}}r}
    \textbf{Automated Synthesis of Asynchronizations} \\
    \hspace{1ex} 29th Static Analysis Symposium (SAS 2022) at SPLASH 2022, Auckland, New Zealand  & \textit{Dec 2022}\\
    \hspace{1ex} Workshop on Verification of Distributed Systems (VDS) 2024 at NETYS 2024, Rabat, Morocco & \textit{May 2024}
  \end{tabular*}
  ...
  \item \begin{tabular*}{7.5in}{l@{\extracolsep{\fill}}r}
        \textbf{Formal Analysis of Engineering Systems Based on Signal-Flow-Graph Theory} \\
        \hspace{1ex} NSV 2016 at CAV 2016, Toronto, Canada  & \textit{Jul 2016}
  \end{tabular*}

  \item \begin{tabular*}{7.5in}{l@{\extracolsep{\fill}}r}
    \textbf{Hierarchical Verification of Quantum Circuits} \\
    \hspace{1ex} 8th NASA Formal Methods Symposium (NFM 2016), Minneapolis, USA (virtual)  & \textit{Jun 2016}
  \end{tabular*}

  \item \begin{tabular*}{7.5in}{l@{\extracolsep{\fill}}r}
    \textbf{Formal Analysis of Power Electronic Systems} \\
    \hspace{1ex} Hardware Verification Group Meeting, Concordia University  & \textit{Oct 2015}
  \end{tabular*}

  \item \begin{tabular*}{7.5in}{l@{\extracolsep{\fill}}r}
    \textbf{On the Formal Analysis of Photonic Signal Processing Systems} \\
    \hspace{1ex} Hardware Verification Group Meeting, Concordia University  & \textit{May 2015}
  \end{tabular*}
