...
\item \hspace{1ex} \parbox{7.3in}{I am interested in algorithmic verification, formal methods, and applying programming
	language techniques to improve asynchronous, concurrent, and distributed systems and smart contracts.}
\end{nonumregion}
...
\begin{nonumregion}{\lbar{red}Education}
  \begin{education}{PhD --- Computer Science}
    ...
    \item
      \begin{itemize}
      \item Thesis Title: \href{https://beillahi.github.io/}{\textbf{Automated Reasonning about Weak Consistency in Distributed Software}}
        \vspace{-0.5ex}
  ...
  \begin{education} {Master of Applied Science --- Computer Engineering}
    ...
    \item
      \begin{itemize}
      \item Thesis Title: \href{https://beillahi.github.io/resouces/papers/MasterThesis.pdf}{\textbf{Towards the Design Automation of Quantum Circuits}}
        \vspace{-0.5ex}
      \item Advisor: Sofi\`{e}ne Tahar
      \end{itemize}
  \end{education}
  \begin{education} {Bachelor of Engineering --- Polytechnicien}
    {Sep 2011 -- Jun 2014}
    {}
...
\begin{nonumregion} {\lbar{orange}Experience}
  ...
  %\end{position}
  \begin{position}{Research Assistant, Universit\'{e} de Paris}{Dec 2017 -- present}
		{Advisors: Ahmed Bouajjani and Constantin Enea}{Paris, France}
  \end{position}
  \positionnodesc{Teaching Assistant, Universit\'{e} de Paris}{Sep 2018 -- present}
...
\begin{itemregion} {\lbar{blue}Awards and Recognitions}
  ...
  \service{Ranked 31st in National Grandes Ecoles Exam, Tunisia, 2011.}
  \service{Olympian in International Mathematical Olympiad, Germany, 2009.}
  \service{Ranked 3rd in National Mathematical Olympiad, Mauritania, 2009.}
  \service{Ranked 1st in National Bac Exam in Mathematics, Mauritania, 2009.}
\end{itemregion}
...
\begin{itemregion} {\lbar{blue}Service}
  \service{Co-organizer, IRIF Verification Seminar, Mar 2020 -- present.}
  \service{Sub-Reviewer: CAV 2020, VMCAI 2020, FTSCS 2016.}
...
\begin{region} {\lbar{purple}Journal Publications}{{J}1}{2}
  ...
  \begin{publicationNote}{https://arxiv.org/pdf/1906.12095.pdf}
    {Robustness Against Transactional Causal Consistency}
    {Dec 2019}{Sidi Mohamed Beillahi, Ahmed Bouajjani, Constantin Enea}
    {Logical Methods in Computer Science (under submission)}
    {Invited Special Issue from CONCUR 2019}
  \end{publicationNote}


  \begin{publication}{https://beillahi.github.io/resouces/papers/FAC19.pdf}
...
\begin{region} {\lbar{purple}Conference Publications}{{C}1}{5}

	\begin{publication} {https://beillahi.github.io/resouces/papers/PLDI20.pdf}
  ...
  \end{publication}
	...
	\begin{publicationNote} {https://beillahi.github.io/resouces/papers/CONCUR19.pdf}
		{Robustness Against Transactional Causal Consistency}
  ...
  \begin{publication} {https://beillahi.github.io/resouces/papers/CAV19.pdf}
  ...
  \begin{publication} {https://beillahi.github.io/resouces/papers/NFM16.pdf}
  ...
  \begin{publication} {https://beillahi.github.io/resouces/papers/ICFEM15.pdf}
...
\begin{region} {\lbar{purple}Workshop Publications}{{W}1}{3}
	...
	\begin{publication}{https://beillahi.github.io/resouces/papers/NSV15.pdf}
  ...
  \end{publication}
	...
	\begin{publication}{https://beillahi.github.io/resouces/papers/FMICS15.pdf}
  ...
  \begin{publication}{https://beillahi.github.io/resouces/papers/ARW15.pdf}
...
\begin{itemregion}{\lbar{blue}Talks}
  ...
  \item \begin{tabular*}{7.5in}{l@{\extracolsep{\fill}}r}
        ...
        \hspace{1ex} ANR Project AdeCoDS Kick-off Meeting, Paris, France  & \textit{Nov 2019} \\
