...
\item \hspace{1ex} \parbox{7.3in}{I am interested in algorithmic verification, formal methods, and applying programming
	language techniques to improve asynchronous, concurrent, distributed, and quantum systems, blockchain, and smart contracts.}
\end{nonumregion}
...
\begin{region} {\lbar{purple}Conference Publications}{{C}1}{8}
  ...
  \begin{publication} {https://beillahi.github.io/papers/SolidityGasOptimization.pdf}
		...
		{Jun 2021} {Keerthi Nelaturu, Sidi Mohamed Beillahi, Fan Long, Andreas Veneris}
