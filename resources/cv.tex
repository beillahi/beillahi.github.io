...
\begin{region} {\lbar{black}Conference Publications}{{C}1}{18}
  ...
  \begin{publication} {https://beillahi.github.io}
		...
		{2023} {Vladyslav Nekriach, \textbf{Sidi Mohamed Beillahi}, Chenxing Li, Peilun Li, Ming Wu, Andreas Veneris, Fan Long}
		{under submission}
  \end{publication}
  ...
  \begin{publication} {https://arxiv.org/pdf/2206.10708.pdf}
		...
		{Accepted to the 46th IEEE/ACM International Conference on Software Engineering (ICSE 2024)}
  \end{publication}
