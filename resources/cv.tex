...
\item \hspace{1ex} \parbox{7.3in}{I am interested in algorithmic verification, formal methods, and programming languages. I develop new techniques to improve the reliability of software systems. I work in a variety of areas: asynchronous programming, distributed systems, smart contracts, and quantum circuits.}
\end{nonumregion}
...
\begin{itemregion} {\lbar{blue}Service}
  ...
  \service{Artificat Evaluation Committees: POPL 2021, CAV 2021, OOPSLA 2021.}
...
\begin{region} {\lbar{purple}Conference Publications}{{C}1}{8}
  ...
  \begin{publication} {https://beillahi.github.io/papers/asynchrony.pdf}
		...
		{Jul 2021} {Sidi Mohamed Beillahi, Ahmed Bouajjani, Constantin Enea, Shuvendu Lahiri}
