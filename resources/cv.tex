...
\item \hspace{1ex} \parbox{7.3in}{I am interested in algorithmic verification, formal verification, and programming languages. I develop new techniques to improve the reliability of software systems. I work in a variety of application areas: distributed systems, blockchain, smart contracts, and asynchronous programming.}
\end{nonumregion}
