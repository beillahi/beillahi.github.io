...
\begin{nonumregion}{\lbar{red}Education}
  ...
  \begin{education} {Master of Applied Science --- Computer Engineering}
    ...
    \item
      \begin{itemize}
      \item Thesis Title: \href{https://beillahi.github.io/}{\textbf{Towards the Design Automation of Quantum Circuits}}
        \vspace{-0.5ex}
...
\begin{region} {\lbar{purple}Workshop Publications}{{W}1}{2}
	...
	\begin{publication}{https://beillahi.github.io}
		...
		{Jun 2015}{Sidi Mohamed Beillahi, Umair Siddique, Sofi\`{e}ne Tahar}
